...
import { Bath, Dumbbell, Waves, ScrollText, Utensils, Wine, Coffee, Clock, Car, Plane, MapPin, Users, Music, BookOpen } from "lucide-react";
...
export default function Amenities() {
  ...
  const getIcon = (categoryName: string, index: number) => {
    const icons = {
      wellness: [<Bath key={0} />, <Dumbbell key={1} />, <Waves key={2} />, <ScrollText key={3} />],
